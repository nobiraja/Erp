...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Edit Student'); ?></title>
    <meta name="description" content="Edit student information in the school management system">
    ...
    <div class="main-content" id="mainContent">
        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="d-flex align-items-center justify-content-between px-4 py-3">
                ...
                <div class="d-flex align-items-center">
                    <a href="/admin/students/<?php echo $student['id']; ?>" class="btn btn-outline-info me-2">
        ...
        <main class="p-4">
            ...
            <form action="/admin/students/<?php echo $student['id']; ?>" method="POST" enctype="multipart/form-data" id="studentForm">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-select <?php echo isset($validation_errors['class_id']) ? 'is-invalid' : ''; ?>"
                                ...
                                <?php foreach ($classes as $class): ?>
                                    <option value="<?php echo $class['id']; ?>" <?php echo ($old_input['class_id'] ?? $student['class_id']) == $class['id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-select <?php echo isset($validation_errors['section']) ? 'is-invalid' : ''; ?>"
                                ...
                                <option value="A" <?php echo ($old_input['section'] ?? $student['section']) === 'A' ? 'selected' : ''; ?>>A</option>
                                <option value="B" <?php echo ($old_input['section'] ?? $student['section']) === 'B' ? 'selected' : ''; ?>>B</option>
                                <option value="C" <?php echo ($old_input['section'] ?? $student['section']) === 'C' ? 'selected' : ''; ?>>C</option>
                            </select>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="date" class="form-control <?php echo isset($validation_errors['dob']) ? 'is-invalid' : ''; ?>"
                                   id="dob" name="dob"
                                   value="<?php echo htmlspecialchars($old_input['dob'] ?? $student['dob']); ?>" required>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-select" id="is_active" name="is_active">
                                <option value="1" <?php echo ($old_input['is_active'] ?? $student['is_active']) == 1 ? 'selected' : ''; ?>>Active</option>
                                <option value="0" <?php echo ($old_input['is_active'] ?? $student['is_active']) == 0 ? 'selected' : ''; ?>>Inactive</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" id="village_address" name="village_address" rows="2"><?php echo htmlspecialchars($old_input['village_address'] ?? $student['village_address'] ?? ''); ?></textarea>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="permanent_address" class="form-label">Permanent Address</label>
                            <textarea class="form-control" id="permanent_address" name="permanent_address" rows="2"><?php echo htmlspecialchars($old_input['permanent_address'] ?? $student['permanent_address'] ?? ''); ?></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="temporary_address" class="form-label">Temporary Address</label>
                            <textarea class="form-control" id="temporary_address" name="temporary_address" rows="2"><?php echo htmlspecialchars($old_input['temporary_address'] ?? $student['temporary_address'] ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="mobile" name="mobile"
                                   value="<?php echo htmlspecialchars($old_input['mobile'] ?? $student['mobile'] ?? ''); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="aadhar" name="aadhar"
                                   value="<?php echo htmlspecialchars($old_input['aadhar'] ?? $student['aadhar'] ?? ''); ?>" maxlength="12">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="samagra" class="form-label">Samagra Number</label>
                            <input type="text" class="form-control" id="samagra" name="samagra"
                                   value="<?php echo htmlspecialchars($old_input['samagra'] ?? $student['samagra'] ?? ''); ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="pan" name="pan"
                                   value="<?php echo htmlspecialchars($old_input['pan'] ?? $student['pan'] ?? ''); ?>" maxlength="10">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="nationality" name="nationality"
                                   value="<?php echo htmlspecialchars($old_input['nationality'] ?? $student['nationality'] ?? 'Indian'); ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="photo-preview" id="photoPreview">
                                <?php if ($student['photo_path'] && file_exists($student['photo_path'])): ?>
                                    <img src="<?php echo htmlspecialchars($student['photo_path']); ?>" alt="Current Photo">
                                <?php else: ?>
    ...
    <script>
        ...
        function previewPhoto(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                preview.innerHTML = `<?php if ($student['photo_path'] && file_exists($student['photo_path'])): ?>
                    <img src="<?php echo htmlspecialchars($student['photo_path']); ?>" alt="Current Photo">
                <?php else: ?>
                    <i class="bi bi-person text-muted fs-1"></i>
                <?php endif; ?>`;
