...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Edit Announcement'); ?></title>
    <meta name="description" content="Edit announcement in the school management system">
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <main class="p-4">
            ...
            <form action="/admin/announcements/<?php echo $announcement['id']; ?>" method="POST" id="announcementForm">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control <?php echo isset($validation_errors['title']) ? 'is-invalid' : ''; ?>"
                                   id="title" name="title"
                                   value="<?php echo htmlspecialchars($old_input['title'] ?? $announcement['title'] ?? ''); ?>" required
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="is_active" name="is_active">
                                <option value="1" <?php echo ($old_input['is_active'] ?? $announcement['is_active'] ?? 1) == 1 ? 'selected' : ''; ?>>Active</option>
                                <option value="0" <?php echo ($old_input['is_active'] ?? $announcement['is_active'] ?? 1) == 0 ? 'selected' : ''; ?>>Inactive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?php echo isset($validation_errors['content']) ? 'is-invalid' : ''; ?>"
                                  ...
                                  placeholder="Enter the announcement content"><?php echo htmlspecialchars($old_input['content'] ?? $announcement['content'] ?? ''); ?></textarea>
                ...
                <div class="form-section">
                    ...
                    <input type="hidden" id="priority" name="priority" value="<?php echo htmlspecialchars($old_input['priority'] ?? $announcement['priority'] ?? 'medium'); ?>">

                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="priority-option card text-center p-3 <?php echo ($old_input['priority'] ?? $announcement['priority'] ?? 'medium') === 'low' ? 'selected' : ''; ?>" data-priority="low">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="priority-option card text-center p-3 <?php echo ($old_input['priority'] ?? $announcement['priority'] ?? 'medium') === 'medium' ? 'selected' : ''; ?>" data-priority="medium">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="priority-option card text-center p-3 <?php echo ($old_input['priority'] ?? $announcement['priority'] ?? '') === 'high' ? 'selected' : ''; ?>" data-priority="high">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="priority-option card text-center p-3 <?php echo ($old_input['priority'] ?? $announcement['priority'] ?? '') === 'urgent' ? 'selected' : ''; ?>" data-priority="urgent">
                ...
                <div class="form-section">
                    ...
                    <input type="hidden" id="visibility" name="visibility" value="<?php echo htmlspecialchars($old_input['visibility'] ?? $announcement['visibility'] ?? 'all'); ?>">

                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <div class="visibility-option card text-center p-3 <?php echo ($old_input['visibility'] ?? $announcement['visibility'] ?? 'all') === 'all' ? 'selected' : ''; ?>" data-visibility="all">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="visibility-option card text-center p-3 <?php echo ($old_input['visibility'] ?? $announcement['visibility'] ?? '') === 'students' ? 'selected' : ''; ?>" data-visibility="students">
                                <div class="text-success mb-2">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="visibility-option card text-center p-3 <?php echo ($old_input['visibility'] ?? $announcement['visibility'] ?? '') === 'teachers' ? 'selected' : ''; ?>" data-visibility="teachers">
                                <div class="text-info mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="visibility-option card text-center p-3 <?php echo ($old_input['visibility'] ?? $announcement['visibility'] ?? '') === 'parents' ? 'selected' : ''; ?>" data-visibility="parents">
                                <div class="text-warning mb-2">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="visibility-option card text-center p-3 <?php echo ($old_input['visibility'] ?? $announcement['visibility'] ?? '') === 'admin' ? 'selected' : ''; ?>" data-visibility="admin">
                                <div class="text-danger mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="expires_at" name="expires_at"
                                   value="<?php echo htmlspecialchars($old_input['expires_at'] ?? ($announcement['expires_at'] ? date('Y-m-d\TH:i', strtotime($announcement['expires_at'])) : '')); ?>">
