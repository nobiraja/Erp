...
<head>
    ...
    <meta name="description" content="Generate attendance reports with filters">
...
<body>
                    ...
                    <div class="card-body">
                        <?php if ($student_id && isset($student)): ?>
                            ...
                            <div class="report-card">
                                <h6 class="mb-3">Student: <?php echo htmlspecialchars($student->first_name . ' ' . $student->last_name); ?> (Scholar No: <?php echo htmlspecialchars($student->scholar_number); ?>)</h6>
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center mt-3">
                                <div class="h5">Average Class Attendance: <strong><?php echo $avgAttendance; ?>%</strong></div>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            <?php else: ?>
                ...
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Please select filters and generate a report to view attendance data.</p>
                    </div>
                </div>
            <?php endif; ?>
        </main>
    ...
    <script>
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        data.data.forEach(student => {
                            options += `<option value="${student.id}">${student.name} (${student.scholar_number})</option>`;
                        });
        ...
        function exportReport() {
            ...
            exportForm.action = '/admin/attendance/export';
