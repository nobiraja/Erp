...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Add New Teacher'); ?></title>
    <meta name="description" content="Add new teacher to the school management system">
...
<body>
    ...
    <div class="main-content" id="mainContent">
        ...
        <main class="p-4">
            ...
            <form action="/admin/teachers" method="POST" enctype="multipart/form-data" id="teacherForm">
                <!-- Basic Information -->
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control <?php echo isset($validation_errors['employee_id']) ? 'is-invalid' : ''; ?>"
                                   ...
                                   value="<?php echo htmlspecialchars($old_input['employee_id'] ?? ''); ?>" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select class="form-select" id="marital_status" name="marital_status">
                                ...
                                <option value="single" <?php echo ($old_input['marital_status'] ?? '') === 'single' ? 'selected' : ''; ?>>Single</option>
                                <option value="married" <?php echo ($old_input['marital_status'] ?? '') === 'married' ? 'selected' : ''; ?>>Married</option>
                                <option value="divorced" <?php echo ($old_input['marital_status'] ?? '') === 'divorced' ? 'selected' : ''; ?>>Divorced</option>
                                <option value="widowed" <?php echo ($old_input['marital_status'] ?? '') === 'widowed' ? 'selected' : ''; ?>>Widowed</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select <?php echo isset($validation_errors['designation']) ? 'is-invalid' : ''; ?>"
                                ...
                                <?php foreach ($designations as $desig): ?>
                                    <option value="<?php echo htmlspecialchars($desig['designation']); ?>" <?php echo ($old_input['designation'] ?? '') === $desig['designation'] ? 'selected' : ''; ?>>
                                        <?php echo htmlspecialchars($desig['designation']); ?>
                                    </option>
                                <?php endforeach; ?>
                                <option value="Teacher" <?php echo ($old_input['designation'] ?? '') === 'Teacher' ? 'selected' : ''; ?>>Teacher</option>
                                <option value="Senior Teacher" <?php echo ($old_input['designation'] ?? '') === 'Senior Teacher' ? 'selected' : ''; ?>>Senior Teacher</option>
                                <option value="Head Teacher" <?php echo ($old_input['designation'] ?? '') === 'Head Teacher' ? 'selected' : ''; ?>>Head Teacher</option>
                                <option value="Principal" <?php echo ($old_input['designation'] ?? '') === 'Principal' ? 'selected' : ''; ?>>Principal</option>
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select <?php echo isset($validation_errors['department']) ? 'is-invalid' : ''; ?>"
                                ...
                                <?php foreach ($departments as $dept): ?>
                                    <option value="<?php echo htmlspecialchars($dept['department']); ?>" <?php echo ($old_input['department'] ?? '') === $dept['department'] ? 'selected' : ''; ?>>
                                        <?php echo htmlspecialchars($dept['department']); ?>
                                    </option>
                                <?php endforeach; ?>
                                <option value="Mathematics" <?php echo ($old_input['department'] ?? '') === 'Mathematics' ? 'selected' : ''; ?>>Mathematics</option>
                                <option value="Science" <?php echo ($old_input['department'] ?? '') === 'Science' ? 'selected' : ''; ?>>Science</option>
                                <option value="English" <?php echo ($old_input['department'] ?? '') === 'English' ? 'selected' : ''; ?>>English</option>
                                <option value="Social Studies" <?php echo ($old_input['department'] ?? '') === 'Social Studies' ? 'selected' : ''; ?>>Social Studies</option>
                                <option value="Hindi" <?php echo ($old_input['department'] ?? '') === 'Hindi' ? 'selected' : ''; ?>>Hindi</option>
                                <option value="Computer Science" <?php echo ($old_input['department'] ?? '') === 'Computer Science' ? 'selected' : ''; ?>>Computer Science</option>
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control <?php echo isset($validation_errors['date_of_joining']) ? 'is-invalid' : ''; ?>"
                                   ...
                                   value="<?php echo htmlspecialchars($old_input['date_of_joining'] ?? ''); ?>" required>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="qualification" name="qualification"
                                   value="<?php echo htmlspecialchars($old_input['qualification'] ?? ''); ?>"
                                   placeholder="e.g., B.Ed, M.Sc">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="specialization" class="form-label">Specialization/Subjects</label>
                            <input type="text" class="form-control" id="specialization" name="specialization"
                                   value="<?php echo htmlspecialchars($old_input['specialization'] ?? ''); ?>"
                                   placeholder="e.g., Physics, Chemistry">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="experience_years" class="form-label">Experience (Years)</label>
                            <input type="number" class="form-control" id="experience_years" name="experience_years"
                                   value="<?php echo htmlspecialchars($old_input['experience_years'] ?? ''); ?>" min="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" id="temporary_address" name="temporary_address" rows="3"><?php echo htmlspecialchars($old_input['temporary_address'] ?? ''); ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="samagra_id" name="samagra_id"
                                   value="<?php echo htmlspecialchars($old_input['samagra_id'] ?? ''); ?>">
                        </div>
                        <div class="col-md-3 mb-3">
    ...
    <script>
        ...
        function generateEmployeeId() {
            ...
            if (!employeeInput.value) {
                ...
                employeeInput.value = `EMP${timestamp}${random}`;
            }
        }
    </script>
</body>
