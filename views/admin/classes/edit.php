        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="d-flex align-items-center justify-content-between px-4 py-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="/admin/classes/<?php echo $class->id; ?>" class="btn btn-outline-info">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin/classes/<?php echo $class->id; ?>" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="academic_year" name="academic_year" required>
                                            ...
                                            for ($i = $currentYear - 1; $i <= $currentYear + 2; $i++):
                                                $year = $i . '-' . ($i + 1);
                                            ?>
                                                <option value="<?php echo $year; ?>" <?php echo $class->academic_year === $year ? 'selected' : ''; ?>>
                                                    <?php echo $year; ?>
                                                </option>
                                            <?php endfor; ?>
                                        </select>
