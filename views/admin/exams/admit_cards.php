...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Admit Cards'); ?></title>
    <meta name="description" content="Generate admit cards for exams in the school management system">
...
<body>
        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="d-flex align-items-center justify-content-between px-4 py-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0">Admit Cards - <?php echo htmlspecialchars($exam->exam_name); ?></h5>
                        ...
                        <div class="card-body">
                            <form id="admitCardForm">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="formatBulk">
                                                    ...
                                                    <br><small class="text-muted">Generate admit cards for all students (2-4 cards per page)</small>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="formatIndividual">
                                                    ...
                                                    <br><small class="text-muted">Generate one card per page for selected students</small>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-primary" onclick="generateAdmitCards()">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>Generate Admit Cards
                                    </button>
                                    <button type="button" class="btn btn-outline-secondary" onclick="previewAdmitCard()">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <div class="text-center text-muted py-4">
                                    ...
                                    <a href="/admin/exams/schedule?exam_id=<?php echo $exam->id; ?>" class="btn btn-sm btn-outline-primary">
                                        Configure Schedule
                                    </a>
                                </div>
                            <?php endif; ?>
                        ...
                        <div class="card-body">
                            <div class="card-preview text-center">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Admit Card Preview</p>
                                    <small class="text-muted">Click "Preview Sample" to see how the admit card will look</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled small mb-3">
                                ...
                                <li><i class="bi bi-check-circle text-success me-2"></i>Exam information</li>
                                <li><i class="bi bi-check-circle text-success me-2"></i>Subject schedule</li>
                            ...
                            <ul class="small text-muted">
                                <li>• Use A4 paper</li>
                                <li>• Print in color for better visibility</li>
                                <li>• Ensure all signatures are included</li>
                                <li>• Bulk format saves paper</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function generateAdmitCards() {
            ...
            let url = `/admin/exams/admit-cards?exam_id=${examId}&format=${format}`;
        ...
        // Preview sample admit card
        function previewAdmitCard() {
            const examId = <?php echo $exam->id; ?>;
            window.open(`/admin/exams/preview-admit-card?exam_id=${examId}`, '_blank');
        }
    </script>
</body>
</html>