...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Create New Exam'); ?></title>
    <meta name="description" content="Create a new exam in the school management system">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/admin/exams/store" method="POST" id="examForm">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <div class="form-text">
                                                Uncheck this if you want to create the exam but keep it inactive for now.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><i class="bi bi-check-circle text-success me-2"></i>Create exam subjects schedule</li>
                                        <li><i class="bi bi-circle text-muted me-2"></i>Enter student results</li>
                                        <li><i class="bi bi-circle text-muted me-2"></i>Generate admit cards</li>
                                        <li><i class="bi bi-circle text-muted me-2"></i>Generate marksheets</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <h6>Tips:</h6>
                                    <ul class="small text-muted">
                                        <li>• Choose descriptive exam names</li>
                                        <li>• Set realistic date ranges</li>
                                        <li>• Ensure class subjects are configured</li>
                                        <li>• Keep exam active for result entry</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (academicYearSelect) {
                ...
                academicYearSelect.value = defaultYear;
            }
        });
    </script>
</body>
