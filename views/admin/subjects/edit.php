...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Edit Subject'); ?></title>
        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="d-flex align-items-center justify-content-between px-4 py-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="/admin/subjects/<?php echo $subject->id; ?>" class="btn btn-outline-info">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h6 class="mb-0">
                                ...
                                Edit Subject: <?php echo htmlspecialchars($subject->subject_name); ?>
                            </h6>
                        </div>
                        <div class="card-body">
                            <form action="/admin/subjects/<?php echo $subject->id; ?>" method="POST">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" id="subject_name" name="subject_name"
                                               ...
                                               placeholder="e.g., Mathematics, English, Physics" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control text-uppercase" id="subject_code" name="subject_code"
                                               value="<?php echo htmlspecialchars($subject->subject_code); ?>"
                                               placeholder="e.g., MATH, ENG, PHY" maxlength="20" required>
                                        <div class="form-text">Unique code for the subject (max 20 chars)</div>
                                    </div>

                                    <div class="col-12">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea class="form-control" id="description" name="description" rows="4"
                                                  placeholder="Brief description of the subject"><?php echo htmlspecialchars($subject->description ?? ''); ?></textarea>
                                        <div class="form-text">Optional description of the subject content</div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="/admin/subjects" class="btn btn-outline-secondary ms-2">
