...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Add New Event'); ?></title>
    <meta name="description" content="Add new event to the school management system">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control <?php echo isset($validation_errors['event_date']) ? 'is-invalid' : ''; ?>"
                                   ...
                                   value="<?php echo htmlspecialchars($old_input['event_date'] ?? ''); ?>" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control" id="event_time" name="event_time"
                                   value="<?php echo htmlspecialchars($old_input['event_time'] ?? ''); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="organizer" name="organizer"
                                   value="<?php echo htmlspecialchars($old_input['organizer'] ?? ''); ?>"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="contact_info" name="contact_info"
                                   value="<?php echo htmlspecialchars($old_input['contact_info'] ?? ''); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control <?php echo isset($validation_errors['description']) ? 'is-invalid' : ''; ?>"
                                  ...
                                  placeholder="Provide detailed description of the event"><?php echo htmlspecialchars($old_input['description'] ?? ''); ?></textarea>
    ...
    <script>
        ...
        function previewImage(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                preview.innerHTML = '<i class="bi bi-calendar-event text-muted fs-1"></i>';
            }
        }
