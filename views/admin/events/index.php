...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Events Management'); ?></title>
    <meta name="description" content="Manage school events and activities">
        ...
        <header class="bg-white shadow-sm border-bottom">
            <div class="d-flex align-items-center justify-content-between px-4 py-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="/admin/events/calendar" class="btn btn-outline-primary">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/admin/announcements">
                ...
                <div class="col-md-3">
                    <div class="card stats-card border-primary">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-2 mb-1"><?php echo number_format($stats['total_events']); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card stats-card border-success">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-2 mb-1"><?php echo number_format($stats['upcoming_events']); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card stats-card border-info">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-2 mb-1"><?php echo number_format($stats['past_events']); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card stats-card border-warning">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mt-2 mb-1"><?php echo number_format($stats['this_month_events']); ?></h4>
                ...
                <form method="GET" class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="status" name="status">
                            <option value="all" <?php echo ($filters['status'] ?? 'all') === 'all' ? 'selected' : ''; ?>>All Events</option>
                            <option value="active" <?php echo ($filters['status'] ?? '') === 'active' ? 'selected' : ''; ?>>Active</option>
                            <option value="inactive" <?php echo ($filters['status'] ?? '') === 'inactive' ? 'selected' : ''; ?>>Inactive</option>
                            <option value="upcoming" <?php echo ($filters['status'] ?? '') === 'upcoming' ? 'selected' : ''; ?>>Upcoming</option>
                            <option value="past" <?php echo ($filters['status'] ?? '') === 'past' ? 'selected' : ''; ?>>Past Events</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="search" name="search"
                               ...
                               placeholder="Search by title, description, location, organizer...">
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">
                        ...
                        Events (<?php echo number_format($pagination['total']); ?>)
                    </h6>
                </div>
                <div class="card-body">
                                ...
                                <?php foreach ($events as $event): ?>
                                    <tr>
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <div class="bg-secondary rounded d-flex align-items-center justify-content-center event-image">
                                        ...
                                        <td>
                                            ...
                                            <small class="text-muted"><?php echo htmlspecialchars(substr($event['description'] ?? '', 0, 50)); ?><?php echo strlen($event['description'] ?? '') > 50 ? '...' : ''; ?></small>
                                        </td>
                                        <td>
                                            <div><?php echo date('d/m/Y', strtotime($event['event_date'])); ?></div>
                                            <small class="text-muted"><?php echo $event['event_time'] ? date('H:i', strtotime($event['event_time'])) : 'TBD'; ?></small>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="/admin/events/<?php echo $event['id']; ?>/edit" class="btn btn-sm btn-outline-warning" title="Edit">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                <button onclick="deleteEvent(<?php echo $event['id']; ?>, '<?php echo htmlspecialchars($event['title']); ?>')" class="btn btn-sm btn-outline-danger" title="Delete">
                        ...
                        <nav aria-label="Events pagination" class="mt-3">
                            <ul class="pagination justify-content-center">
                                <?php if ($pagination['current_page'] > 1): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="?page=<?php echo $pagination['current_page'] - 1; ?>&status=<?php echo $filters['status'] ?? 'all'; ?>&search=<?php echo urlencode($filters['search'] ?? ''); ?>">
                                            Previous
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php for ($i = max(1, $pagination['current_page'] - 2); $i <= min($pagination['total_pages'], $pagination['current_page'] + 2); $i++): ?>
                                    <li class="page-item <?php echo $i === $pagination['current_page'] ? 'active' : ''; ?>">
                                        <a class="page-link" href="?page=<?php echo $i; ?>&status=<?php echo $filters['status'] ?? 'all'; ?>&search=<?php echo urlencode($filters['search'] ?? ''); ?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php endfor; ?>
